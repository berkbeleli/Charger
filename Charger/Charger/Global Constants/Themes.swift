...
struct Themes {
  ...
  static let colorGrayScale = UIColor(named: "GrayScale")!
  static let colorSecurity = UIColor(named: "SecurityPink")!
  ...
  static let fontBoldMakeAppointmentHeader = UIFont(name: "Proxima Nova Bold", size: 15)!
